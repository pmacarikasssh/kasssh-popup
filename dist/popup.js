(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function o(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(e){if(e.ep)return;e.ep=!0;const a=o(e);fetch(e.href,a)}})();const m=(s,t,o,n=".")=>`
...
`;const h=s=>{var t=document.currentScript||document.querySelector(`script[src*="${s}"]`);const[,o]=t.src.match(/^(.*)(\/.*\.js)/);return o};let l="kasssh-popup-container",p=0;const g=(s,t)=>{document.querySelector("[data-kasssh-close]").addEventListener("click",()=>{t?t():r(!1)});const o=document.querySelector("[data-kasssh-submit]");o.disabled=!0,o.addEventListener("click",()=>{s({phone:u()}),r(!1)}),document.querySelector("[data-kasssh-tnc]").addEventListener("change",d),document.querySelector("[data-kasssh-phone]").addEventListener("change",d)},d=()=>{const s=document.querySelector("[data-kasssh-submit]");s.disabled=!0,!(p>300)&&u()&&document.querySelector("[data-kasssh-tnc]").checked&&(s.disabled=!1)},u=()=>{let s=document.querySelector("[data-kasssh-phone]");return s=s.tagName=="INPUT"?s.value:s.innerText,/^\d{10,}$/.test(s)?s:null},v=({email:s,phone:t,amount:o},n,e=null,a="popup.js")=>{p=o;const c=document.getElementById(l);c&&c.remove();const i=document.createElement("div");i.id=l,i.style.display="none",i.innerHTML=m(s,t,o,h(a)),document.body.appendChild(i),g(n,e),o<=300&&(document.querySelector("[data-kasssh-amount-error]").style.display="none")},r=s=>{const t=document.getElementById(l);s?t.style.display="block":t.style.display="none"};window.initKassshPopup=v;window.toggleKassshPopup=r;
